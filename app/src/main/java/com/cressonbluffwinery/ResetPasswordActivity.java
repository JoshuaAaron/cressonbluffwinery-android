...
public class ResetPasswordActivity extends AppCompatActivity
{
    ...
    private TextView passwordReset, titleQuestions;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        validateUser = findViewById(R.id.validate_btn);
    ...
    protected void onStart()
    {
        ...
        if (check.equals("profile settings"))
        {
            passwordReset.setText("Set Security Questions");
            titleQuestions.setText("Please set your answers to the following security questions");
            validateUser.setText("Update Answers");
        ...
        else
        {
            ...
            ref.child("Security Questions").updateChildren(userDataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull @NotNull Task<Void> task)
                {
                    ...
                    {
                        Toast.makeText(ResetPasswordActivity.this, "Answers updated successfully!", Toast.LENGTH_SHORT).show();
    ...
    private void verifyUser()
    {
                ...
                public void onDataChange(@NonNull @NotNull DataSnapshot dataSnapshot)
                {
                    if (dataSnapshot.exists())
                    {
                        ...
                        if (dataSnapshot.hasChild("Security Questions"))
                        {
                            ...
                            if (!ans1.equals(answer1) || !ans2.equals(answer2) || !ans3.equals(answer3))
                            {
                                Toast.makeText(ResetPasswordActivity.this, "The answers you provided were incorrect. Please try again.", Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
                                ...
                                newPassword.setHint("Please enter a new password");
                    ...
                    {
                        Toast.makeText(ResetPasswordActivity.this, "This number is not associated with any current active account. Please try again.", Toast.LENGTH_SHORT).show();
                    }
        ...
        {
            Toast.makeText(this, "The information you provided was incorrect. Please try again.", Toast.LENGTH_SHORT).show();
        }
    }
}